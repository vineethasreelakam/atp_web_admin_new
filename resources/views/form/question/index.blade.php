        ...
        <div class="content-wrapper">
            <div class="content-header row">
                ...
                <div class="col-md-3 mb-1"style="float:right;">
                    <a href="{{route('formQuestion.create',['formId'=>$formId])}}">
                ...
                <div class="row" id="basic-table">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="card-text">
                                The administrator can edit existing questions, add new ones, and modify option values as needed on this platform.                                </p>
                            </div>
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item" href="{{route('formQuestion.create',['id'=>$row->id,'formId'=>$formId,'rule_id'=>$row->rule_id])}}">
                                                                    <i data-feather="edit-2" class="mr-50"></i>
                                                                    <span>Edit</span>
                                                                </a>
                                                                <a class="dropdown-item btn_delete" href="javascript:void(0);" data-url="{{route('formQuestion.delete',['id'=>$row->id,'formId'=>$formId])}}">
