<?php
   ...
   $userAccessData=UserAccess::with('PrivillegeMaster')->where('user_id',$userId)->get();
   //print_r($userAccessData->flatMap->PrivillegeMaster);exit;
   $privillegsArray=[];
   foreach($userAccessData->flatMap->PrivillegeMaster as $val){
        $privillegsArray[$val->value]=$val->value;
   }
            ...
            <ul class="nav navbar-nav align-items-center ml-auto">
              <!--   <li class="nav-item dropdown dropdown-language"><a class="nav-link dropdown-toggle" id="dropdown-flag" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="flag-icon flag-icon-us"></i><span class="selected-language">English</span></a>
                ...
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="user-nav d-sm-flex d-none"><span class="user-name font-weight-bolder">{{Session::get('user_name')}}</span><span class="user-status">{{$user->Role->title}}</span></div><span class="avatar"><img class="round" src="{{asset('public/app-assets/images/portrait/small/user.png')}}" alt="avatar" height="40" width="40"><span class="avatar-status-online"></span></span>
                    </a>
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <!-- <li class=" nav-item"><a class="d-flex align-items-center" href="{{url('/dashboard')}}"><i data-feather="home"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Dashboards</span></a>
                    ...
                    <?php
                        if((isset($privillegsArray) && array_key_exists('subadmin_manage',$privillegsArray)) || $type=='super_admin'){
                    ?>    
                            <li class=" nav-item">
                                <a class="d-flex align-items-center" href="{{route('admin')}}"><i data-feather="pen-tool"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Manage Supervisor</span></a>
                            </li>
                    <?php
                        }
                        if((isset($privillegsArray) && array_key_exists('user_manage',$privillegsArray)) || $type=='super_admin'){
                    ?>
                    <li class=" nav-item">
                    ...
                    <?php
                        ...
                        if((isset($privillegsArray) && array_key_exists('manage_role',$privillegsArray)) || $type=='super_admin'){
                    ?>
                    <li class=" nav-item">
                    ...
                    ?>
                    <li class=" nav-item">
                        <a class="d-flex align-items-center" href="{{route('form')}}"><i data-feather="package"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Manage Form</span></a>
                    </li>
                    <?php
                        }
                        if((isset($privillegsArray) && array_key_exists('view_form',$privillegsArray)) || $type=='super_admin'){
                    ?>
                    <li class=" nav-item">
                        <a class="d-flex align-items-center" href="{{route('formview')}}"><i data-feather="eye"></i><span class="menu-title text-truncate" data-i18n="Dashboards">View Form </span></a>
                    </li>
                    <?php
                        }
                        if((isset($privillegsArray) && array_key_exists('manage_tournament',$privillegsArray)) || $type=='super_admin'){
                    ?>
                    <li class=" nav-item">
                        <a class="d-flex align-items-center" href="{{route('tournament')}}"><i data-feather="framer"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Manage Tournament</span></a>
                    </li>
                    <?php
                        }
                    ?>
