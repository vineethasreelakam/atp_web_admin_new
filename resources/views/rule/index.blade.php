                ...
                <div class="row" id="basic-table">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="card-text">
                                The admin has the authority to customize formatting rules for form questions on this page, granting flexibility and adaptability.                                </p>
                            </div>
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item" href="{{route('rule.create',['id'=>$row->id])}}">
                                                                    <i data-feather="edit-2" class="mr-50"></i>
                                                                    <span>Edit</span>
                                                                </a>
                                                                <a class="dropdown-item btn_delete" href="javascript:void(0);" data-url="{{route('rule.delete',$row->id)}}">
